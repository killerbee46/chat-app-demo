...
const AddChatModal: React.FC<{
  ...
  const getUsers = async () => {
    ...
    requestHandler(
      ...
      (res:any) => {
        ...
        setUsers(res|| []); // Set users data or an empty array if data is absent
      },
  ...
  const createNewChat = async () => {
    ...
    await requestHandler(
      ...
      async () => await createUserChat(selectedUserId.toString()),
                ...
                <div>
                  ...
                  <div className="my-5">
                    <Select
                      ...
                      value={isGroupChat ? "" : selectedUserId?.toString() || ""}
