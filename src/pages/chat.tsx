...
const [chatChanged,setChatChanged]= useState<null| number>(null);
  ...
  const updateChatLastMessage = (
    ...
    chatToUpdate.last_message = message;
  ...
  const updateChatLastMessageOnDeletion = (
    ...
    if (chatToUpdate.last_message?._id === message._id) {
      requestHandler(
        ...
        (req) => {
          ...
          chatToUpdate.last_message = data[0];
          setChats([...chats]);
        },
        alert
      );
...
const _currentChat = LocalStorage.get("currentChat");
  ...
  return (
    <>
      ...
      <div className="w-full justify-between bg-black items-stretch h-screen flex flex-shrink-0">
